...
class TestAutoMLPipeline:
    ...
    def test_default_model_registration(self):
        ...
        expected_models = ['RandomForest', 'LogisticRegression', 'GradientBoosting', 'DecisionTree', 'AdaBoost']
    ...
    def test_large_dataset_handling(self):
        ...
        X_train, X_test, y_train, y_test = DataUtils.train_test_split(X_df, y_series, test_size=0.2, random_state=42)
